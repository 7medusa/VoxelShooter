...
void draw(glm::mat4 modelViewProj, glm::mat4 projection, glm::mat4 model, const int modelViewProjLocation, int64_t numIndices, const VertexBuffer* vertexBuffer, const IndexBuffer* indexBuffer, int modelViewLocation, int invModelViewLocation, glm::mat4 modelView, glm::mat4 invModelView, Camera* camera) {
    vertexBuffer->bind();
    indexBuffer->bind();
